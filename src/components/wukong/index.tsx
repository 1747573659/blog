...
export default function WuKong() {
  ...
  const eyes = (ctx: any, transition: any) => {
    ...
    let lineGradient1 = ctx.createLinearGradient(294, 184, 287, 199)
    ...
    ctx.fill()
    lineGradient1 = ctx.createLinearGradient(290, 201, 285, 216)
  ...
  const lineGradient = (ctx: any, x1: any, y1: any, x2: any, y2: any, color1: any, color2: any, color3: any, color4: any) => {
    let lineGradient11 = ctx.createLinearGradient(x1, y1, x2, y2)
  ...
  return <canvas ref={canvas} width='650' height='671'></canvas>
}
